...
{	
	...
	{ 
		...
		heartrateTopic_heading.innerHTML = "Heartrate: " + message.payloadString;
	} 
	else if (message.destinationName == brightnessTopic) 
	{
		...
		brightnessTopic_heading.innerHTML = "Brightness: " + message.payloadString;
	} 
	else if (message.destinationName == temperatureTopic) 
	{
		...
		temperatureTopic_heading.innerHTML = "Temperature: " + message.payloadString;
	}
}
